...
consumer = client.subscribe(topic, subscription_name=subscription, consumer_type=ConsumerType.Shared, ack_timeout_ms=10000, negative_ack_redelivery_delay_ms=5000)
